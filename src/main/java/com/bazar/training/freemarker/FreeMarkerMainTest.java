...
import com.bazar.training.data_model.ValueExampleObject;
...
public class FreeMarkerMainTest {
	 ...
	 public static void excecute() throws Exception {
	       ...
	       // cfg.setClassForTemplateLoading(FreeMarkerMainTest.class, "/com/bazar/training/freemarker");
	        cfg.setClassForTemplateLoading(FreeMarkerMainTest.class, "/templates");
	        ...
	        input.put("exampleObject", new ValueExampleObject("Java object", "foka"));
